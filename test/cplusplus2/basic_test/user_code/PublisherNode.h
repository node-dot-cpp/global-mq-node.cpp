...
class PublisherNode : public NodeBase
{
	...
	basic_test::publishable_sample_WrapperForPublisher<GMQueueStatePublisherSubscriberTypeInfo::ComposerT> publishedStateWrapper;
...
//		log::default_log::log( log::LogLevel::fatal, "     text                   : {}\n", rq.text );
		...
		typename GMQueueStatePublisherSubscriberTypeInfo::ComposerT c = buff;


		basic_test::scope_test_exchange::composeMessage<basic_test::scope_test_exchange::srv_response>(c, basic_test::replied_on = reply.replied_on, basic_test::value = reply.value, basic_test::text_from_server = reply.text_from_server );
